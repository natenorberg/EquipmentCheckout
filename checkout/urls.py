...
urlpatterns = patterns('',
                       ...
                       url(r'equipment/subitem/(?P<sub_item_id>\d+)/', sub_item_detail),
                       url(r'equipment/(?P<equipment_id>\d+)/subitem/edit/(?P<sub_item_id>\d+)/', edit_sub_item),
                       url(r'equipment/(?P<equipment_id>\d+)/subitem/delete/', delete_sub_item),
                       url(r'equipment/add/$', new_equipment),
                       url(r'equipment/add/(?P<equipment_id>\d+)/options/', add_sub_item),
